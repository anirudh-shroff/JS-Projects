...
const xIcon = `<img src="./assets/images/x.png" alt="x-symbol" class="x-icon" width="50%" height="50%">`;
const oIcon = `<img src="./assets/images/o.png" alt="o-symbol" class="o-icon" width="50%" height="50%">`;
...
function winAlert(player) {
    Swal.fire({
        ...
        backdrop: `
                rgba(125, 125, 125, 0)
                url("./assets/images/DDt.gif")
                center center / 150rem 150rem
                no-repeat                
        `
    });
}
